...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url(); ?>asset/user/css/plugin.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/user/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/user/css/flaticon.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/user/css/custom.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/user/css/responsive.css" rel="stylesheet">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="logo">
                                <a href="#"><img src="<?php echo base_url(); ?>asset/user/images/logo.png" class="img-responsive"></a>
                            </div>
