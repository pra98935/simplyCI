...
jQuery("#updatervwfrm").on('submit', (function(e) {
    e.preventDefault();
    tinyMCE.triggerSave();
    <?php  $id = $result->id; ?>
    var url = "<?php echo base_url('admin/updatereview/'.$id.''); ?>"; 
    jQuery.ajax({
        url: url,
        type: "POST",
...
<div class="col-sm-8">
	<div class="admin_leftbar owner_admin">
		...
		<div class="row">
			<?php if($result){ ?>
            <form role="form" method="post" id="updatervwfrm" action="#">
				<div class="col-sm-12">
					<div class="form-group">
						<label for="customer_name">Customer Name:</label>
						<input type="text" class="form-control" id="" name="name" value="<?php echo $result->name; ?>">
				...
				<div class="col-lg-12 nopadding">
					<div class="form-group">
						...
						<textarea id="editoraddreview" name="review">
