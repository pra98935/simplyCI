...
jQuery(document).ready(function(){
    ...
    jQuery("#addcouponfrm").on('submit', (function(e) {
        e.preventDefault();
        ...
        var url = "<?php echo base_url('admin/addcouponAction'); ?>"; 
...
<div class="col-sm-8">
	<div class="admin_leftbar owner_admin">
		<h3 class="admin_heading">Add New Coupon</h3>
		
		<form method="post" action="#" id="addcouponfrm">
			...
			<div class="col-sm-12">
                <div class="form-group">
			        ...
			        <input type="text" value="" name="coupon_code" id="coupontext" class="">
                    <span class="err coupon_code"></span>
                </div>
            </div>
			...
			<div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" name="offer" class="form-control" id="coupon_ofr">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" id="datepicker" class="form-control" name="exp_date">
             ...
             <div class="col-sm-12">
                <div class="form-group">
                    <button type="submit" class="btn btn-coupon">Add Coupon</button>
                </div>
            </div>
